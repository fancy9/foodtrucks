...
public:
	...
	UccDBQuerry(string collection, string locationType, const string* location, const string* radius,
			const string* limit, const string* foodItems, const string* sortText,
